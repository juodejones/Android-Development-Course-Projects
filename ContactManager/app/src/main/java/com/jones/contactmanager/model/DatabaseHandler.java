package com.jones.contactmanager.model;
...
import com.jones.contactmanager.R;
import com.jones.contactmanager.data.Contact;
import com.jones.contactmanager.util.Util;
...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public void addContact(Contact contact) {
        ...
        values.put(Util.KEY_PHONE_NUMBER, contact.getPh_no());
    ...
    public Contact getContact(int id) {
        ...
        // query(table_name, columns, selection, selectionArgs, groupBy, having, orderBy)
        ...
        contact.setPh_no(cursor.getString(2));
    ...
    public List<Contact> getAllContacts() {
        ...
        // query(sql_command, selectionArgs)
    ...
    public int updateContact(Contact contact) {
        ...
        //update the row
        // update(table_name, ContentValues, where (id = ?), where_args)
        return db.update(Util.TABLE_NAME, values, Util.KEY_ID + "=?", new String[]{String.valueOf(contact.getId())});

    }

    public void deleteContatct(Contact contact) {
